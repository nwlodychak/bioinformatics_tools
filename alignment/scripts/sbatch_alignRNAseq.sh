...
echo "Migrate FASTQ to working directory $(date)"
bash scripts/migrateFASTQ.sh 1>results/logs/$SLURM_JOB_NAME-$SLURM_JOB_ID-migrateFASTQ.log 2>results/logs/$SLURM_JOB_NAME-$SLURM_JOB_ID-migrateFASTQ.log
